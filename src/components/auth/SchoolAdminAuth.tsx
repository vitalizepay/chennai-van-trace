...
interface SchoolAdminAuthProps {
  onSuccess: () => void;
}

const SchoolAdminAuth = ({ onSuccess }: SchoolAdminAuthProps) => {
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description: "Welcome back, School Admin!",
        });
        onSuccess();
      }
    } catch (err) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs text-muted-foreground text-center mt-4">
        <p>School Admin access with mobile number and password authentication</p>
      </div>
    </div>
  );
};

export default SchoolAdminAuth;